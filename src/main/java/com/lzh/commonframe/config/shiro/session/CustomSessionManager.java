package com.lzh.commonframe.config.shiro.session;

import com.lzh.commonframe.moudle.user.domain.User;
import com.lzh.commonframe.config.shiro.CustomShiroSessionDAO;
import com.lzh.commonframe.moudle.user.domain.UserOnline;
...
public class CustomSessionManager {
	...
	public Map<String, Object> changeSessionStatus(Boolean status,
		...
		try {
			...
			System.out.println(getClass().toString()+ e.toString()+ "改变Session状态错误，sessionId[%s]"+sessionIds);
			map.put("status", 500);
